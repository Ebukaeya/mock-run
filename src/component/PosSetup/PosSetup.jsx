  ...
  const posSetups = [
    {
      ...
      specifications: {
        ...
        Printer: "Thermal 80mm external",
        Battery: "5000mAh",
        OS: "windows",
      },
      images: [
        { id: 1, type: "front", src: "https://res.cloudinary.com/ebuka1122/image/upload/v1749333563/Ihub/LaptopSetup_gvcalp.webp", label: "Front View" },
    ...
    },
    {
      ...
      specifications: {
        ...
        Printer: "External Thermal 80mm",
        Battery: "N/A (Plug-in)",
        OS: "Android 12",
      },
      images: [
        { id: 1, type: "front", src: "https://res.cloudinary.com/ebuka1122/image/upload/v1749334767/Ihub/AndriodPOS_mtw05f.webp", label: "Front View" },
        { id: 2, type: "side", label: "Side View" },
        { id: 3, type: "back", label: "Back View" },
        { id: 4, type: "display", label: "Display" },
      ],
    },
    {
      ...
      images: [
        { id: 1, type: "front", src: "https://res.cloudinary.com/ebuka1122/image/upload/v1749333566/Ihub/windowsSetup_ptaxnp.webp", label: "Front View" },
        { id: 2, type: "side", label: "Side View" },
        { id: 3, type: "back", label: "Back View" },
        { id: 4, type: "display", label: "Display" },
      ],
    },
    {
      ...
      images: [
        { id: 1, type: "front", src: "https://images.unsplash.com/photo-1483058712412-4245e9b90334?auto=format&fit=crop&w=800&h=500", label: "Front View" },
        { id: 2, type: "side", label: "Side View" },
        { id: 3, type: "back", label: "Back View" },
        { id: 4, type: "display", label: "Display" },
      ],
