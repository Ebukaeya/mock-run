...
const VideoGallery = () => {
  ...
  const demoVideos = [
    ...
    },
    {
      ...
      description: "Explore powerful analytics and reporting tools that give you insights into your business.",
    ...
    },
    {
      ...
      description: "See how teams of all sizes collaborate seamlessly using our platform.",
      youtubeId: "dQw4w9WgXcQ",
      duration: "5:45",
    ...
    },
    {
      ...
      description: "Step-by-step guide to integrating our API with your existing tools and workflows.",
      youtubeId: "dQw4w9WgXcQ",
      duration: "8:22",
